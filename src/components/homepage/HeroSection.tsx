        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className={`transition-all duration-700 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              <Link href="/contact" className="btn-accent text-center text-base md:text-lg">
                Get a Free Quote
              </Link>
              <Link href="/portfolio" className="bg-white/10 backdrop-blur-sm border border-white/30 text-white px-6 py-3 rounded-md font-semibold hover:bg-white/20 transition-all duration-300 text-center text-base md:text-lg">
                View Our Work
              </Link>
            </div>
          </div>

          {/* Stats Card - Hidden on small mobile, shown on md+ */}
          <div className={`hidden md:block transition-all duration-700 delay-300 ${loaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-white/10">
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                <div className="bg-white/20 rounded-xl p-4 md:p-6 text-center hover:bg-white/30 transition-all duration-300 transform hover:scale-105">
