    ...
    <section className="relative py-16 md:py-24 bg-gradient-to-br from-primary-dark via-primary to-secondary overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/contact"
            className="group relative btn-accent text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 shadow-lg shadow-accent/30 hover:shadow-accent/50 transition-all duration-300 overflow-hidden w-full sm:w-auto"
          >
          ...
          <Link
            href="/contact"
            className="group relative glass-tech neon-border text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:shadow-neon transition-all duration-300 cursor-pointer text-base sm:text-lg overflow-hidden w-full sm:w-auto"
          >
        ...
        {/* Quick Trust Signals */}
        <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 sm:gap-8 mt-10 sm:mt-12">
          <div className="group flex items-center gap-3 glass-tech px-4 py-3 rounded-xl neon-border hover:shadow-neon transition-all duration-300 w-full sm:w-auto sm:flex-1">
